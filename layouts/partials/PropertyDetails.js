...
const PropertyDetails = () => {
  return (
  <>
  <div class="flex flex-col gap-[20px] px-5 lg:px-[10px] py-[20px] lg:py-[20px]">
    ...
    <div class="w-full lg:w-1/2 flex flex-col gap-[30px]">
    <div class="text-lg font-bold text-gray-700 text-center lg:text-left">Features of Property</div>
